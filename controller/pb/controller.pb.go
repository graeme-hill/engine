...
type Game struct {
	...
	TickInterceptURL        string `protobuf:"bytes,11,opt,name=TickInterceptURL,proto3" json:"TickInterceptURL,omitempty"`
}
...
func (m *Game) GetTickInterceptURL() string {
	if m != nil {
		return m.TickInterceptURL
	}
	return ""
}
...
func (this *Game) Equal(that interface{}) bool {
	...
	if this.TickInterceptURL != that1.TickInterceptURL {
		return false
	}
	return true
}
...
func NewPopulatedGame(r randyController, easy bool) *Game {
	...
	this.TickInterceptURL = string(randStringController(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
var fileDescriptorController = []byte{
	...
	,
}
